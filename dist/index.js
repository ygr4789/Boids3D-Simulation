...
function rule4(i) {
    var dir = new THREE.Vector3().subVectors(intersectionPoint, boidsP[i]).normalize();
    var ret = new THREE.Vector3().subVectors(dir.multiplyScalar(velocityLimit), boidsV[i]);
